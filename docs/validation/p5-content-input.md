...
Subsequent real development-node preparation, Controller hash readback, fixed-d2core Ready/full-reclaim checks and old-game switch/rollback are recorded separately in [P5A](p5a.md) and [P5B](p5b.md). No original owner-supplied VPK or template was passed directly to Content Tool or installed in place. Human entry and publication remain pending.
