...
Subsequent real development-node preparation, Controller hash readback, fixed-d2core Ready/full-reclaim checks, human entry of the new game's `custom` mode, publication of `p5-2307479570-v1`, and old-game switch/rollback are recorded separately in [P5A](p5a.md) and [P5B](p5b.md). No original owner-supplied VPK or template was passed directly to Content Tool or installed in place. The old game's legacy version and the new game's other presets remain outside human gameplay acceptance.
