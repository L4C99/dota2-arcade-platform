...
Subsequent real development-node preparation, Controller hash readback, fixed-d2core Ready/full-reclaim checks, human entry of all three new-game modes and the old game's legacy version on both development nodes, publication of both new targets, and old-game switch/rollback are recorded separately in [P5A](p5a.md) and [P5B](p5b.md). No original owner-supplied VPK or template was passed directly to Content Tool or installed in place.
